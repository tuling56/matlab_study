function F = hog(img, cellpw, cellph, nblockw, nblockh,...
...
%
% OVERLAP:
%       OVERLAP is the overlap proportion of two neighboring
%       block., also called  blockstride
%
% ISGLOBALINTERPOLATE:
...
%img =imread('E:\dataset\INRIAPerson\INRIAPerson\Train\pos\person_and_bike_209.png','png'); 
%img = imread('E:\dataset\MIT CBCL pedestrians128x64\per00924.ppm','ppm'); 
%img = imread('walker1','jpg');  %ÊäÈëµÄÍ¼Ïñ
[M, N, K] = size(img);
