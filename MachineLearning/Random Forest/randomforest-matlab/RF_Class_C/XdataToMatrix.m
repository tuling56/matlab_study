function Xtwonorm = XdataToMatrix(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   XTWONORM = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   XTWONORM = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Xtwonorm = importfile('X_twonorm.txt', 1, 300);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2013/07/02 11:49:46
